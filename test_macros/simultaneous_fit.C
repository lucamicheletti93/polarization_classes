...
void simultaneous_fit(){
  ...
  //TFile *fileAccxEff = new TFile("iterative_procedure/4pT6/AccxEffReWeighted3rdStep.root","READ");   // 3rd iteration
  ...
  TFile *fileAccxEff = new TFile("iterative_procedure/6pT10/AccxEffReWeighted3rdStep.root","READ");   // 3rd iteration
